...
Public Class sqlcon
    '----ivan local DB
    Public DBCon As New SqlConnection("Data Source=172.16.7.7;Initial Catalog=APPS_GSC;Persist Security Info=True;User ID=HSDP_DEPOT;Password=123456$hsdp")
    ''EVERMORE DB
    'Public DBCon As New SqlConnection("Data Source=172.16.4.111;Initial Catalog=Importer;User ID=HSDPI;Password=123456$hsdp")
    ''HSDP
